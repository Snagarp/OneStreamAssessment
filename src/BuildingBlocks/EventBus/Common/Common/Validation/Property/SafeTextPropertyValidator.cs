...
{
    /// <summary>
    /// Validates that string property does not contains certain unsafe symbol characters.
    /// </summary>
    /// <seealso cref="PropertyValidator" />
    public sealed class SafeTextPropertyValidator<T, TProperty> : PropertyValidator<T, TProperty>
    {
        public override string Name => "SafeTextPropertyValidator";
