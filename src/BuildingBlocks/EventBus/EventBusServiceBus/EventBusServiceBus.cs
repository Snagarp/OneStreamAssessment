...
public class EventBusServiceBus : IEventBus, IAsyncDisposable
{
    ...
    public EventBusServiceBus(IServiceBusPersisterConnection serviceBusPersisterConnection,
        ...
        IServiceProvider serviceProvider, string subscriptionClientName, string topicName)
    {
        ...
        EnsureSubscriptionExists().GetAwaiter().GetResult();
    ...
    private async Task EnsureTopicExists()
    {
        ...
        {
            _logger.LogInformation("The topic {TopicName} already exists.", _topicName);
        }
    }
    ...
    private async Task EnsureSubscriptionExists()
    {
        ...
        {
            _logger.LogInformation("The subscription {SubscriptionName} already exists.", _subscriptionName);
        }
    }
}
