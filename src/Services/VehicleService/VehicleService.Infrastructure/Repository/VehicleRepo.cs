...
namespace Vehicle.Infrastructure.Repository
{
    ...
    internal class VehicleRepo(AppDbContext context) : IVehicle
    {
        ...
        private async Task<Domain.Entity.VehicleEntity.Vehicle?> FindVehicleByName(string name) =>
        ...
        /// <returns>The vehicle entity if found; otherwise, null.</returns>
        private async Task<Domain.Entity.VehicleEntity.Vehicle?> FindVehicleById(int id) =>
        ...
        public async Task<Response> AddVehicle(CreateVehicleRequestDTO model)
        {
            ...
            _context.Vehicles.Add(model.Adapt<Domain.Entity.VehicleEntity.Vehicle>());
        ...
        public async Task<Response> UpdateVehicle(UpdateVehicleRequestDTO model)
        {
            ...
            _context.Vehicles.Update(model.Adapt<Domain.Entity.VehicleEntity.Vehicle>());
            await SaveChangesAsync();
